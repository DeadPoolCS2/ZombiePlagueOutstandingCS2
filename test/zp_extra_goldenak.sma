...
new AK_V_MODEL[64] = "models/ZombieOutStanding/v_golden_ak47.mdl"
new AK_P_MODEL[64] = "models/ZombieOutStanding/p_golden_ak47.mdl"
...
public plugin_init()
{
	...
	/* CVARS */
	cvar_dmgmultiplier = register_cvar("zp_goldenak_dmg_multiplier", "1.3")
...
public zp_extra_item_selected(player, itemid)
{
	if ( itemid == g_itemid )
	{
		...
		ShowSyncHudMsg(0, h_h, ".:: %s bought Golden Klashnikov ::.", h_Name);
		g_HasAk[player] = true;
	}
}
